...
class WYXYSpider(Spider):
    name = 'whys'
    start_urls = ['https://whys.sdwu.edu.cn/index/tzgg/{}.htm'.format(str(i)) for i in range(58, 1, -1)]
    start_urls.insert(0,'https://whys.sdwu.edu.cn/index/xydt.htm')
    def parse(self, response):
        ...
        for one_selector in selector_list:
            ...
            if'https' in content_url:
                ...
                content_url = 'http://whys.sdwu.edu.cn/'+content_url
