...
class WYXYSpider(Spider):
    name = 'nywyxy'
    start_urls = ['https://nywyxy.sdwu.edu.cn/index/xyxw/{}.htm'.format(str(i)) for i in range(17, 1, -1)]
    start_urls.insert(0,'https://nywyxy.sdwu.edu.cn/index/xyxw.htm')
    def parse(self, response):
        ...
        for one_selector in selector_list:
            ...
            if'https' in content_url:
                ...
                content_url = 'http://nywyxy.sdwu.edu.cn/'+content_url
